...
$active_menu = $uri_segments[2]; // for www.example.com/user/account you will get 'user'
?>
...
<header class="navbar navbar-expand-md d-print-none" >
        <div class="container-xl">
          ...
          <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
            <a href=".">
              <img src="<?php echo $base_url; ?>/assets/logo.svg" width="110" height="32" alt="Tabler" class="navbar-brand-image">
            </a>
          </h1>
            ...
            <div class="container-xl">
              <ul class="navbar-nav">
                ...
                <li class="nav-item <?= ($active_menu == 'category') ? 'active' : '' ?>">
                  <a class="nav-link" href="<?php echo $base_url; ?>/category/index.php" >
                ...
                <li class="nav-item <?= ($active_menu == 'product') ? 'active' : '' ?>">
                  <a class="nav-link" href="<?php echo $base_url; ?>/product/index.php" >
                    <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/checkbox -->
                ...
                <li class="nav-item <?= ($active_menu == 'booking') ? 'active' : '' ?>">
                  <a class="nav-link" href="<?php echo $base_url; ?>/booking/index.php" >
                    <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/checkbox -->
                ...
                <li class="nav-item <?= ($active_menu == 'checkout') ? 'active' : '' ?>">
                  <a class="nav-link" href="<?php echo $base_url; ?>/checkout/index.php" >
                    <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/checkbox -->
                ...
                <li class="nav-item <?= ($active_menu == 'history') ? 'active' : '' ?>">
                  <a class="nav-link" href="<?php echo $base_url; ?>/history/index.php" >
                    <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/checkbox -->
