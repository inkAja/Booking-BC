...
if(isset($_POST["submit"])){
    ...
    $aksi = mysqli_query($connect, "INSERT INTO categories VALUES(NULL,'$name')");
            ...
            <form class="card" method="POST">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" class="form-control" aria-describedby="emailHelp" placeholder="Masukan Kategori">
                    </div>
                </div>
